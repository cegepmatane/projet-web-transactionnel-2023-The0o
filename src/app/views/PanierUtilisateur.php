...
$panier = $panierController->ListPanierProduit($_SESSION['mailClient']);
?>
        ...
        <div class="item">
            <div class="contenu-commande">
                <div class="info-nom-categorie">
                    <div class="nom-produit txt-g3">Air Max 270</div>
                    <div class="categorie">Sportswear Essentials</div>
                </div>
